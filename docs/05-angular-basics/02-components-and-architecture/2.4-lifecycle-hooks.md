...
export class TaskItem implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      console.log(
        `${LIFECYCLE_EVENT_ICON.effect} TaskItem ${this.task().id}: effect() tracked`,
      );
    });
  }
  ...
  ngOnInit() {
    ...
    console.log(
      `${LIFECYCLE_EVENT_ICON.init} TaskItem ${this.task().id}: ngOnInit() tracked`,
    );
  }
        ...
        <div class="space-y-1 max-h-32 overflow-y-auto">
          ...
          >
            ...
            <span class="font-mono text-[10px] opacity-75">
              ...
              {{ LIFECYCLE_EVENT_ICON[event.type] }}
            </span>
          </div>
        </div>
      </div>

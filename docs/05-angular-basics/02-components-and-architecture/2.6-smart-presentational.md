...
@Component({
  ...
  template: `
    <div
      class="max-w-2xl mx-auto p-6 bg-linear-to-br from-blue-50 to-indigo-100 min-h-screen"
    >
      ...
      <div class="grid grid-cols-2 gap-4 mb-6">
        <div
          class="p-4 bg-white/70 backdrop-blur rounded-xl shadow-lg text-center"
        >
...
export class TaskShellComponent {
  ...
  taskChildrenQueryFromBoard = signal<
    ReturnType<typeof viewChildren<TaskItem>> | undefined
  >(undefined);
  ...
  lastTaskTitle = computed(() => {
    ...
    return children && children.length > 0
      ? children[children.length - 1]?.task()?.title
      : "None";
  });

  onViewChildrenReady(
    childrenQuery: ReturnType<typeof viewChildren<TaskItem>>,
  ) {
  ...
  onEmptyStateClick(
    taskFormRef: ReturnType<typeof viewChild<TaskFormComponent>>,
  ) {

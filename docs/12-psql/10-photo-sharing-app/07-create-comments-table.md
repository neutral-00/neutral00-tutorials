...
We already establish the relationship between users and photos.

Next let's establish relationship among comments, photos and users.

So a photo will have many comments. \
And a user can have many comments.

Reset the DB.
So let's design the comments table as shown below:
...
You can refer this link for [ER diagram](https://drive.google.com/file/d/1V718U-0XLa3HPwae-PU2jPOUPZHhSPv2/view?usp=drive_link)
